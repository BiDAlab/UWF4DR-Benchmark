...
Due to licensing constraints imposed by the UWF4DR Challenge dataset, official annotations and ground-truth labels are **not redistributed** in this repository.
